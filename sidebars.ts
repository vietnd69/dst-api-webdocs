	...
	docs: [
		{
			...
			link: {
				type: "doc",
				id: "api-vanilla/getting-started/index",
			},
			items: [
		...
		},
		{
			...
			items: [
				...
				"api-vanilla/core-systems/actions",
				"api-vanilla/core-systems/constants",
				"api-vanilla/core-systems/cooking",
				"api-vanilla/core-systems/recipes",
				"api-vanilla/core-systems/tuning",
				...
				// 		"api-vanilla/core/tuning",
				// 		"api-vanilla/core/animstate-system",
				// 	],
				// },
		...
		// 	link: {
		// 		type: "doc",
		// 		id: "api-vanilla/updates/api-updates",
		// 	},
		// 	items: [
		// 		"api-vanilla/updates/api-changelog",
		// 		"api-vanilla/updates/mod-release-ids",
		// 		"api-vanilla/updates/mod-updating-guide",
		// 		"api-vanilla/updates/deprecated-features",
		// 		"api-vanilla/updates/backwards-compatibility",
		// 		"api-vanilla/updates/migration-guides",
		// 	],
		// },
		// {
		// 	type: "html",
		...
		// 	},
		// 	items: [
		// 		"api-vanilla/debugging-and-testing/debugging-and-testing",
		// 		"api-vanilla/debugging-and-testing/testing-environment",
		// 		"api-vanilla/debugging-and-testing/troubleshooting-guide",
		// 	],
		// },
		// {
		// 	type: "html",
		...
		// 	},
		// 	items: [
		// 		"api-vanilla/development-tools/vscode-setup",
		// 		"api-vanilla/development-tools/git-integration",
		// 		"api-vanilla/development-tools/useful-extensions",
		// 		"api-vanilla/development-tools/cicd-workflow",
		// 		"api-vanilla/development-tools/project-management",
		// 	],
		// },
	],
};
