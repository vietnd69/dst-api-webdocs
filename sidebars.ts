			...
			items: [
				{
					...
					link: {
						type: "generated-index",
						title: "Levels",
						description: "DST levels API documentation",
					},
					items: [
						{
							type: "autogenerated",
							dirName: "game-scripts/map/levels",
						}
					]
				},
				{
					...
					link: {
						type: "generated-index",
						title: "Rooms",
						description: "DST rooms API documentation",
					},
					items: [
						{
							type: "category",
							...
							items: [{
								type: "autogenerated",
								dirName: "game-scripts/map/rooms/cave"
							}]
						},
						{
							type: "category",
							...
							items: [{
								type: "autogenerated",
								dirName: "game-scripts/map/rooms/forest"
							}]
						}
					]
				},
				{
					type: "category",
					label: "Static Layouts",
					collapsed: true,
					link: {
						type: "generated-index",
						title: "Static Layouts",
						description: "DST static layouts API documentation",
					},
					items: [
						// {
						// 	type: "category",
						...
						// 		type: "generated-index",
						// 		title: "Events",
						// 		description: "DST events API documentation",
						// 	},
						// 	items: [{
						// 		type: "autogenerated",
						// 		dirName: "game-scripts/map/static_layouts/events"
						// 	}]
						// },
						// {
						// 	type: "category",
						...
						// 		type: "generated-index",
						// 		title: "Grotto",
						// 		description: "DST grotto API documentation",
						// 	},
						// 	items: [{
						// 		type: "autogenerated",
						// 		dirName: "game-scripts/map/static_layouts/grotto"
						// 	}]
						// },
						// {
						// 	type: "category",
						...
						// 	items: [{
						// 		type: "autogenerated",
						// 		dirName: "game-scripts/map/static_layouts/rooms"
						// 	}]
						// },
						{
							type: "autogenerated",
							dirName: "game-scripts/map/static_layouts"
						}
					]
				},
