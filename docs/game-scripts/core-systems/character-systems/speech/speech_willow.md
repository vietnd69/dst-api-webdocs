...
### Rift 5 Content
Willow's responses to new Rift 5 mechanics with her characteristic fire-focused perspective:
```lua
-- Rift 5 - New floating mechanics with pyrotechnic observations
